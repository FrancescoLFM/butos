...
//...
static const struct builtin_command builtin_commands[] = {BUILTIN_COMMAND("print", print_program), BUILTIN_COMMAND("set", set_var_str), BUILTIN_COMMAND("let", set_var_int)};
